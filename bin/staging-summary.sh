...
echo "   - Modifies Dockerfiles (same logic as current)"
...
echo "   5. PREVIOUS_RELEASE          - Previously deployed final image tag"
echo ""

echo "Usage Examples:"
echo "   Manual:"
echo "     ./bin/stg-workflow.sh 1.2.3 2.1.0 true false 1.2.2"
echo "     ./bin/stg-workflow.sh 1.2.3 '' false false 1.2.2  # Uses ZIP_VERSION for SAST"
echo ""
echo "   GitHub Actions:"
echo "     Use: new-stg-build-publish-tag-final-image.yaml"
echo "     Inputs: ZipVersion, PreviousTag, SastSelfContainedVersion, IsLatest, SkipGit"
echo ""
...
echo "✨ Ready to use! Configure the placeholders and test with a dry run."
