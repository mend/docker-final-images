...
wssGheAppVersion=$(grep -Eo -m 1 'wss-ghe-app:25.10.1.3-cs-beta' build.sh | head -1)
...
wssScannerVersion=$(grep -Eo -m 1 'wss-scanner:25.10.1.3-cs-beta' build.sh | head -1)
...
wssRemediateVersion=$(grep -Eo -m 1 'wss-remediate:25.10.1-c-beta' build.sh | head -1)
